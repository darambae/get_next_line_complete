...
/*   Updated: 2024/03/14 13:35:57 by dabae            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

static  void	extract_rest(t_line *buf_list, char **rest)
{
	t_line	*last_node = NULL;
...
static	int	found_n(t_line *buf_list)
{
	int	i;
